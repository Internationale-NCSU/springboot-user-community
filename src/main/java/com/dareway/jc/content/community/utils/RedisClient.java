...
public class RedisClient {
    ...
    private static final String ERROR_HAPPEN = "error happened:";
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            logger.error("RedisClient expire error:", e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean hasKey(String key) {
        try {
            ...
            logger.error("haskey error:", e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean hmset(String key, Map<String, Object> map, long time) {
        try {
            ...
            logger.error(ERROR_HAPPEN, e.getMessage(), e);
            return false;
        }
    }
